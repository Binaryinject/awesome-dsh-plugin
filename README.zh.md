...
- [Binaryinject/dsh-review-checkout](https://github.com/Binaryinject/dsh-review-checkout) — Codex 风格的会话文件修改审查：每轮变更卡片、语法高亮 diff 审查标签（分屏/卡片双视图）、跟随 DSH 主题的深浅双套配色、内置工具按轮一键撤销——基于官方会话通道。
